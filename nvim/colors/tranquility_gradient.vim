...
let s:darkgray    = ['#44475A', 239]
let s:purple      = ['#995D81', 125]
let s:pink        = ['#FCB5B5', 217]
...
call s:h('TranquilityPurple', s:pink)
call s:h('TranquilityPurpleItalic', s:pink, s:none, [s:attrs.italic])
...
call s:h('TranquilityInfoLine', s:none, s:none, [s:attrs.undercurl], s:pink)

call s:h('TranquilityTodo', s:pink, s:none, [s:attrs.bold, s:attrs.inverse])
call s:h('TranquilitySearch', s:orange, s:none, [s:attrs.inverse])
call s:h('TranquilityBoundary', s:comment, s:bglight)
call s:h('TranquilityLink', s:pink, s:none, [s:attrs.underline])
