...
call s:h('TranquilityPurple', s:teal)
call s:h('TranquilityPurpleItalic', s:teal, s:none, [s:attrs.italic])
...
call s:h('TranquilityInfoLine', s:none, s:none, [s:attrs.undercurl], s:teal)

call s:h('TranquilityTodo', s:teal, s:none, [s:attrs.bold, s:attrs.inverse])
call s:h('TranquilitySearch', s:orange, s:none, [s:attrs.inverse])
call s:h('TranquilityBoundary', s:comment, s:bglight)
call s:h('TranquilityLink', s:teal, s:none, [s:attrs.underline])
